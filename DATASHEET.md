# Datasheet — Tarot-Draw 1.7B training and evaluation corpora
...
Used to train and evaluate **Tarot-Draw 1.7B and Tarot-Draw 8B**, which share this corpus exactly. Not suitable for: studying Manifold
